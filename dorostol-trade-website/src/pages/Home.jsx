  ...
  <>
    <section id="hero" className="relative overflow-hidden bg-brand-950 text-white">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
        <div>
          <p className="mb-5 text-xs font-bold uppercase tracking-[0.3em] text-accent-200">Vegetable Protein and Oil Plant</p>
        ...
        <div className="rounded-[2rem] border border-white/15 bg-white/10 p-7 shadow-2xl backdrop-blur sm:p-9">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-accent-200">Project Focus</p>
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {[
            ...
            <div key={label} className="rounded-2xl border border-brand-900/5 bg-brand-50 p-6">
    ...
    <section id="partners" className="bg-earth-100 py-20 sm:py-24">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        <p className="mt-5 text-xs font-bold uppercase tracking-[0.24em] text-accent-600">Partnership Opportunities</p>
    ...
    <section id="contact" className="bg-brand-50 py-20 sm:py-24">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        ...
        />
        <div className="grid gap-4 sm:grid-cols-2">
          <a href="mailto:office@dorostol.trade" className="rounded-2xl border border-brand-900/10 bg-white p-5 transition hover:border-accent-500">
          ...
          <a href="mailto:atanasov@dorostol.trade" className="rounded-2xl border border-brand-900/10 bg-white p-5 transition hover:border-accent-500">
