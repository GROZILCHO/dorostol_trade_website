...
## Project
Dorostol Trade SRL corporate website.

## Current Objective
Establish a reviewed documentation baseline before implementation work starts.

## Repository Context
- Root repository: project source of truth.
- Frontend: React/Vite prototype in `dorostol-trade-website/`.
- Backend: Flask/Python prototype in `dorostol-trade-backend/`.
- Design references: screenshots in `docs/design-reference/`.
